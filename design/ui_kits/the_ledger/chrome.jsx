/* =====================================================================
   ...
   Copied from design/ui_kits/foundation/chrome.jsx with the file name,
   menu items, and breadcrumbs re-pointed at The Ledger v1.
    ...
    <div style={{ background: '#F1F3F4', height: '100%', display: 'flex', flexDirection: 'column', fontFamily: 'Jost,sans-serif', color: '#202124' }}>
      ...
      <div style={{ padding: '8px 14px 4px 14px', background: '#FFFFFF', borderBottom: '1px solid #E8EAED', display: 'flex', alignItems: 'center', gap: 10 }}>
        <div style={{ width: 28, height: 28, background: '#1C3D2E', borderRadius: 4, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <img src="../../assets/logo-icon-on-forest.svg" alt="" style={{ height: 22, width: 'auto' }} />
        </div>
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <div style={{ fontSize: 14, fontWeight: 500, color: '#202124' }}>The Ledger v1 — Chen Studio</div>
      ...
      <div style={{ background: '#FFFFFF', borderBottom: '1px solid #E8EAED', padding: '5px 14px', display: 'flex', alignItems: 'center', gap: 8, fontSize: 12 }}>
        <span style={{ background: '#F1F3F4', padding: '4px 10px', borderRadius: 4, color: '#5F6368', minWidth: 56, textAlign: 'center' }}>C9</span>
        <span style={{ color: '#5F6368', fontFamily: 'monospace' }}>ƒx</span>
        <span style={{ color: '#202124', fontFamily: 'monospace', fontSize: 12 }}>=cc_setaside_pct</span>
      </div>
      ...
      <div style={{ flex: 1, overflow: 'hidden', background: 'var(--pal-bg, #FAF8F2)', position: 'relative' }}>
        {/* Row number strip + content scroll */}
...
function ScriptMenu({ close }) {
  const items = [
    { label: 'Add Account…',                 sep: 'after' },
    { label: 'Import Bank Transactions' },
    { label: 'Clear Paste Zone' },
    { label: 'Recategorize Ledger from Rules' },
    { label: 'Sort Transactions by Date',    sep: 'after' },
    { label: 'Apply Theme',                  sep: 'after' },
    { label: 'Renumber Ledger',              sep: 'after' },
