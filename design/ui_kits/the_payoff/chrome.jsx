/* =====================================================================
   ...
   Copied from design/ui_kits/the_ledger/chrome.jsx with the file name,
   menu items, and breadcrumbs re-pointed at The Payoff v1.
    ...
    <div style={{ background: '#F1F3F4', height: '100%', display: 'flex', flexDirection: 'column', fontFamily: 'Jost,sans-serif', color: '#202124' }}>
      ...
      <div style={{ padding: '8px 14px 4px 14px', background: '#FFFFFF', borderBottom: '1px solid #E8EAED', display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <div style={{ fontSize: 14, fontWeight: 500, color: '#202124' }}>The Payoff v1 — Casey Alvarez</div>
      ...
      <div style={{ background: '#FFFFFF', borderBottom: '1px solid #E8EAED', padding: '5px 14px', display: 'flex', alignItems: 'center', gap: 8, fontSize: 12 }}>
        <span style={{ background: '#F1F3F4', padding: '4px 10px', borderRadius: 4, color: '#5F6368', minWidth: 56, textAlign: 'center' }}>C10</span>
        <span style={{ color: '#5F6368', fontFamily: 'monospace' }}>ƒx</span>
        <span style={{ color: '#202124', fontFamily: 'monospace', fontSize: 12 }}>=cc_active_strategy</span>
      </div>
...
function ScriptMenu({ close, onAction }) {
  const items = [
    ...
    { label: 'Renumber Payments',            sep: 'after' },
